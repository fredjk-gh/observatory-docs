...
> Some plugins may be incompatible with this release. If you run into issues with Observatory not starting please try removing third-party plugins or rolling back to v1.3.0.

> As of this writing StatScanner is known to be incompatible.

> A fix to allow Observatory to launch with incompatible plugins will come shortly after Christmas.
